...
public class JResizedIcon extends ImageIcon
{
   ...
   public static enum IconUrls
   {
      ...
      ICON_GREYSCALE                   ("i_Greyscale.png"),
      ICON_NOMAP                       ("i_NoMap.png"),
      ...
      ICON_TREE_SERVER                 ("i_TreeServer.png"),
      ...
      ICON_APP_PREF_AUTODISCONNECT     ("i_AppPrefAutoDisconnect.png"),
