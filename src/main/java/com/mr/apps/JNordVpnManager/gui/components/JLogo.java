...
public class JLogo extends JLabel
{
   ...
   public static enum Logos
   {
      ...
      LOGO_GITHUB_SPONSORS("mrLogo",
            "<html><font face=\"sansserif\" color=\"black\">If you like to support my work,<br>you can press the Mouse Button to go to GitHub Sponsorship:<br>https://github.com/sponsors/com-mr-apps</font></html>",
