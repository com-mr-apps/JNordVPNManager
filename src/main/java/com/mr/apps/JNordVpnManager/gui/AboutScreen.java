...
public class AboutScreen
{
   ...
   + "<p>Key Features:</p>"
   + "<ul>"
   + "<li><strong>Server Search</strong>: Easily find and connect to VPN servers from all around the world using filters by country and city.</li>"
