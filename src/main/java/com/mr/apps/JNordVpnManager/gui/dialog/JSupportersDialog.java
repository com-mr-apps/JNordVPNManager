...
public class JSupportersDialog extends JFrame
{
   private static final String m_htmlText = "<h1>Support My Open-Source Software Development</h1>"
         ...
         + "<h2>Why Your Sponsorship Matters</h2>"
         + "<p>Funding is required for the ongoing development and maintenance of these applications. Your sponsorship will not only help sustain my work but also provide a financial incentive for further improving and maintaining the software. This, in turn, will lead to:</p>"
         + "<ul>"
         ...
         + "<h2>How Your Sponsorship Will Be Used</h2>"
         ...
         + "<h3>What Are The JNordVPN Manager Accelerate Development Features</h3>"
         + "<h4>Here is a list of features for which you can speed up development (suggestions welcome):</h4>"
         + "<ul>"
         ...
         + "<p>By sponsoring my work, you&#39;ll be contributing to the growth and improvement of the software community as a whole. I&#39;m grateful for your support and look forward to collaborating with you!</p>"
