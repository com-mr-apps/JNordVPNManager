...
public class JWhatsNewDialog
{
   private static final String m_htmlAboutText = "<h2>JNordVPN Manager Version History.</h2>"
         ...
         + "<ul>"
         + "<li><strong>Obfuscated Server Connections</strong>: Added support of the NordVPN setting <em>Obfuscated</em> for OPENVPN technology. If <em>enabled</>, the server tree list displays only servers which support obfuscation. For more information see: <a href=\"https://support.nordvpn.com/hc/en-us/articles/19479130821521-Different-NordVPN-server-categories-explained#h_01HGTG79DQP0NW71K286YDW061\">Obfuscated Servers Explained [NordVPN Support]</a></p>\"</li>"
         + "</ul>"
         + "<h3>What's Next:</h3>"
         + "<ul>"
         ...
         + "Functionality that is not planned yet. The start of implementation can be accelerated by donations."
         + "<ul>"
