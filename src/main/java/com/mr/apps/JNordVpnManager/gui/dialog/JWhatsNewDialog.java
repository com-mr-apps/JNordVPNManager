...
public class JWhatsNewDialog
{
   private static final String m_htmlAboutText = "<h2>JNordVPN Manager Version History.</h2>"
         ...
         + "<li><strong>Recent Server List</strong>: Each <code>Recent Servers</code> list item now stores additional information about the connection group, technology and protocol.</p></li>"
         ...
         + "<li><strong>Application Preferences</strong>: With the setting <code>Auto Update Server Data on Program Start</code>, now the number of days for an automatic update of the server list on program start can be set.</p></li>"
         + "<li><strong>Server List Tree</strong>: Added country flags to Server List Tree icons and changed styles.</p></li>"
         + "</ul>"
