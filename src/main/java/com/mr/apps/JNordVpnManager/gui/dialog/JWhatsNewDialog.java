...
public class JWhatsNewDialog
{
   private static final String m_htmlAboutText = "<h2>JNordVPN Manager Version History.</h2>"
         + "<h3>What's New:</h3>"
         + "</ul>"
         + "<h4>Version 2026.2.1 (Snap 2026.2.1):</h4>"
         + "[Released February 2026]"
         + "<ul>"
         + "<li><strong>Download Speed Test</strong>: Updated Server List.</li>"
         + "<li><strong>NordVPN v4.4.0 Update</strong>: Fixed problems in Account and Settings data parsing.</li>"
         ...
         + "[Released Mai 2025]"
         + "<ul>"
         + "<li><strong>Average Round-Trip Time (RTT)</strong>: Measure the Average Round-Trip Time (RTT) to a VPN host with the ping command.</li>"
         + "<li><strong>NordVPN Server Hosts</strong>: Enhanced infrastructure to manage and display over 7000 VPN Server Hosts.</li>"
