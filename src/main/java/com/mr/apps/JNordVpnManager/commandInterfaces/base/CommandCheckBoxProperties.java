...
/**
 * Enhanced Dataset for Command CheckBox Gadgets.
 * <p>
 ...
 * </ul>
 */
public class CommandCheckBoxProperties extends CommandGadgetProperties
{

   private Boolean m_selected = null;

   public CommandCheckBoxProperties(String label, String toolTip, Boolean enabled, Boolean selected, IconUrls iconUrl, IconSize iconSize)
   {
